...
class Order:
    ...
    def sanity_check(self, only_last = False):
        ...
        use_reactor = set([TRAIN_MARINE, TRAIN_REAPER, BUILD_WIDOW_MINE, BUILD_HELLION, BUILD_VIKING, BUILD_MEDIVAC])
        use_tech_lab = set([TRAIN_MARAUDER, TRAIN_GHOST, BUILD_SIEGE_TANK, BUILD_THOR, BUILD_BANSHEE, BUILD_RAVEN, BUILD_BATTLE_CRUISER,
                            RESEARCH_CONCUSSIVE_SHELLS, RESEARCH_STIMPACK, RESEARCH_COMBAT_SHIELD,
                            RESEARCH_INFERNAL_PRE_IGNITER, RESEARCH_DRILLING_CLAWS, RESEARCH_TRANSFORMATION_SERVOS,
                            RESEARCH_CADUCEUS_REACTOR, RESEARCH_CORVID_REACTOR, RESEARCH_DURABLE_MATERIALS, RESEARCH_CLOAKING_FIELD])
        to_reactor = set([ATTACH_REACTOR_TO_BARRACKS, ATTACH_REACTOR_TO_FACTORY, ATTACH_REACTOR_TO_STARPORT])
        to_tech_lab = set([ATTACH_TECH_LAB_TO_BARRACKS, ATTACH_TECH_LAB_TO_FACTORY, ATTACH_TECH_LAB_TO_STARPORT])
        from_reactor = set([SEPARATE_REACTOR_FROM_BARRACKS, SEPARATE_REACTOR_FROM_FACTORY, SEPARATE_REACTOR_FROM_STARPORT])
        from_tech_lab = set([SEPARATE_TECH_LAB_FROM_BARRACKS, SEPARATE_TECH_LAB_FROM_FACTORY, SEPARATE_TECH_LAB_FROM_STARPORT])
        uses_barracks = set([ATTACH_REACTOR_TO_BARRACKS, ATTACH_TECH_LAB_TO_BARRACKS, SEPARATE_REACTOR_FROM_BARRACKS, SEPARATE_TECH_LAB_FROM_BARRACKS,
                             TRAIN_MARINE, TRAIN_REAPER, TRAIN_MARAUDER, TRAIN_GHOST,
                             RESEARCH_CONCUSSIVE_SHELLS, RESEARCH_STIMPACK, RESEARCH_COMBAT_SHIELD])
        uses_factory = set([ATTACH_REACTOR_TO_FACTORY, ATTACH_TECH_LAB_TO_FACTORY, SEPARATE_REACTOR_FROM_FACTORY, SEPARATE_TECH_LAB_FROM_FACTORY,
                            BUILD_WIDOW_MINE, BUILD_HELLION, BUILD_SIEGE_TANK, BUILD_THOR,
                            RESEARCH_INFERNAL_PRE_IGNITER, RESEARCH_DRILLING_CLAWS, RESEARCH_TRANSFORMATION_SERVOS])
        uses_starport = set([ATTACH_REACTOR_TO_STARPORT, ATTACH_TECH_LAB_TO_STARPORT, SEPARATE_REACTOR_FROM_STARPORT, SEPARATE_TECH_LAB_FROM_STARPORT,
                            BUILD_VIKING, BUILD_MEDIVAC, BUILD_BANSHEE, BUILD_RAVEN, BUILD_BATTLE_CRUISER,
                            RESEARCH_CADUCEUS_REACTOR, RESEARCH_CORVID_REACTOR, RESEARCH_DURABLE_MATERIALS, RESEARCH_CLOAKING_FIELD])
        to_add_on = to_reactor | to_tech_lab
        from_add_on = from_reactor | from_tech_lab
        use_add_on = use_reactor | use_techlab
        to_from_add_on = to_add_on | from_add_on
        add_on_events = to_from_add_on | use_add_on
